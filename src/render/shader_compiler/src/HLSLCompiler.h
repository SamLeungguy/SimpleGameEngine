...
private:
	...
	void _reflect(ShaderType type_, ComPtr<ID3D11ShaderReflection>& cpReflection_, ComPtr<ID3DBlob>& cpBlob_);
	...
	void _writeToJsonFile_uniformBuffers(json& out_, SPtr<ShaderInfo>& spInfo_);
